...
function setup(){
    ...
    world = engine.world;
    ground = new Ground(240,610,470,20);
    wall1 = new Ground(120,480,12,270);
    wall2 = new Ground(5,480,12,270);
    wall3 = new Ground(475,480,12,270);
    wall4 = new Ground(240,480,12,270);
    wall5 = new Ground(360,480,12,270);
...
function draw(){
    ...
    if(frameCount%80===0){
        particles.push(new Particle(random(width/3-10,width/3+10),10,10));
    }
